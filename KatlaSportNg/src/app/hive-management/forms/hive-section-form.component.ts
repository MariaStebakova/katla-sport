...
export class HiveSectionFormComponent implements OnInit {
  ...
  onSubmit() {
    if (!this.existed) {
      this.hiveSectionService.addHive(this.hiveSection).subscribe(s => this.navigateToSections());
    }
    else {
      this.hiveSectionService.updateHive(this.hiveSection).subscribe(s => this.navigateToSections());
    }
  }
  ...
  onPurge() {
    this.hiveSectionService.deleteHive(this.hiveSection.id).subscribe(s => this.navigateToSections());
  }
}
